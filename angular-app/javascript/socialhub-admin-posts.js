var API_BASE_URL = "/admin/api/posts";

var PostLoadInProgress = false;
var SinceIndex = "";
var BeforeIndex = "";
var PostsPerPage = 12;
var postFilters = {status: "pending", count: PostsPerPage};
var noResultsMsg = $('<div>').addClass("hubpost noresults").html("<p><span>0</span> Posts</p>");
